  ...
  .factory(
    ...
    function (
      ...
      returnValue = {
        ...
        localStorage: delegateStorage(
          connectionDeferred.promise,
          'localStorage',
        ),
        sessionStorage: delegateStorage(
          connectionDeferred.promise,
          'sessionStorage',
        ),
      };
      appContext().then(function (appInfo) {
        ...
        port.onMessage.addListener(function (message) {
          if (message == 'portConnected') {
            if (appInfo.id) {
              evalService
                .evalFunction(extensionPageInject, { APP_ID: runtime.id })
                .then(function () {
            ...
            message.from.app == appInfo.id &&
            message.from.tab == appInfo.tabId &&
            message.obj.change
          ) {
